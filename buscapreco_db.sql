drop database buscaprecodb;
drop user buscapreco;
create user buscapreco with password 'password';
create database buscaprecodb with template=template0 owner=buscapreco;
\connect buscaprecodb;
alter default privileges grant all on tables to buscapreco;
alter default privileges grant all on sequences to buscapreco;
